...
import com.mykid.platform.common.annotation.Limit;
...
import com.mykid.platform.common.utils.CaptchaUtil;
import com.mykid.platform.common.utils.MD5Util;
import com.mykid.platform.pojo.entity.LoginLog;
import com.mykid.platform.service.ILoginLogService;
...
public class LoginController extends BaseController {
    ...
    public PlatformResponse login(
            @NotBlank(message = "{required}") String username,
            @NotBlank(message = "{required}") String password,
            @NotBlank(message = "{required}") String verifyCode,
            boolean rememberMe, HttpServletRequest request) throws PlatformException {
    ...
    @PostMapping("regist")
    public PlatformResponse regist(
            @NotBlank(message = "{required}") String username,
            @NotBlank(message = "{required}") String password) throws PlatformException {
    ...
    public PlatformResponse index(@NotBlank(message = "{required}") @PathVariable String username) {
        // 更新登录时间
