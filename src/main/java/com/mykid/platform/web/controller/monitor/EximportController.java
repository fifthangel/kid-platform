...
import com.mykid.platform.pojo.entity.Eximport;
import com.mykid.platform.service.IEximportService;
...
public class EximportController extends BaseController {
    ...
    public PlatformResponse importExcels(MultipartFile file) throws PlatformException {
        try {
            if (file.isEmpty()) {
    ...
    public void export(QueryRequest queryRequest, Eximport eximport, HttpServletResponse response) throws PlatformException {
        try {
