 ...
 */
@PlatformEndPoint
public class PlatformMetricsEndpoint {

    private final MeterRegistry registry;

    public PlatformMetricsEndpoint(MeterRegistry registry) {
    ...
    public MetricResponse metric(String requiredMetricName, List<String> tag) {
